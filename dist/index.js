...
exports.HorizonBase = exports.GitRefType = void 0;
var GitRefType;
(function (GitRefType) {
...
class HorizonBase {
    ...
    request(link, { query = {}, method = 'GET', body } = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!resp.ok) {
                throw new Error(`${resp.status} ${resp.statusText}: ${yield resp.text()}`);
            }
    ...
    buildDeploy(cluster_id, gitRefType, ref, title, description) {
        return __awaiter(this, void 0, void 0, function* () {
            const body = {
                title,
                description: description !== null && description !== void 0 ? description : '',
...
exports.HorizonBase = HorizonBase;
...
const horizon_1 = __nccwpck_require__(984);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = core.getInput('token');
            const addr = core.getInput('addr');
            const type = core.getInput('deployMethod');
            const title = core.getInput('title');
            const clusterID = parseInt(core.getInput('clusterID'));
            const description = core.getInput('description');
            const horizonBaseClient = new horizon_1.HorizonBase(addr, token);
            if (type === 'imageDeploy') {
                const tag = core.getInput('tag');
                horizonBaseClient.deploy(clusterID, title, tag, description);
            }
            else if (type === 'buildDeploy') {
                const gitRefType = core.getInput('gitRefType');
                if (!Object.values(horizon_1.GitRefType).includes(gitRefType)) {
                    throw new Error(`gitRefType must be one of ${Object.values(horizon_1.GitRefType)}`);
                }
                const ref = core.getInput('ref');
                yield horizonBaseClient.buildDeploy(clusterID, gitRefType, ref, title, description);
            }
        }
        catch (error) {
